# This file contains additional code to the Stable Baselines3 library
# Since the Stable Baselines3 library contains only the Vanilla DQN code implementation, we added a Double DQN code implementation
import warnings
...
class DDQN(OffPolicyAlgorithm):
    ...
    Default hyperparameters are taken from the Nature paper of DQN,
