# This file contains code modifications of the Stable Baselines3 ppo.py file 
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
			    ...
			    # SUFT CHANGE
                suft_ope_term = F.mse_loss(values, rollout_data.old_values) * self.tf_lambda
                value_loss = value_loss + suft_ope_term
