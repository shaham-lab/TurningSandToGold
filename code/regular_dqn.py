...
# Since the Stable Baselines3 library contains only the Vanilla DQN code implementation, we added a DQN code implementation
import warnings
...
class DQN1(OffPolicyAlgorithm):
    """
    Deep Q-Network (DQN) - not vanilla DQN
